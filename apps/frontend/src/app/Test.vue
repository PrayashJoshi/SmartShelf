<template>
  <div class="lg:flex flex-col lg:items-start lg:justify-between">
    <div class="lg:flex w-full lg:items-center lg:justify-between">
      <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Welcome Back, Bob!</h2>
      <button class="p-2.5 rounded-md text-indigo-600 font-medium bg-gray-100">Capture Receipt</button>
    </div>
    <div>
